...
excerpt: 'Eunwoo Kim, Chanho Ahn, and Songhwai Oh'
date: 2018-06-01
venue: 'IEEE Conference on Computer Vision and Patter Recognition (CVPR)'
paperurl: ''
citation: 'Eunwoo Kim, Chanho Ahn, and Songhwai Oh, “NestedNet: Learning Nested Sparse Structures in Deep Neural Networks”, in Proc. of the IEEE Conference on Computer Vision and Patter Recognition (CVPR), Jun. 2018. (Spotlight Presentation, 8.7% Acceptance Rate)'
---
